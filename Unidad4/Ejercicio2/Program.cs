...
namespace Ejercicio2
{
    class Program
    {
        ...
        */
        {
            float impTotal, litros;
            Console.WriteLine("Ingresar el importe total de la venta: ");
            impTotal = float.Parse(Console.ReadLine());
            ...
            if( litros > 500)
                ...
                impTotal *= 0.90F;
            Console.WriteLine("El Importe con descuento es: " + impTotal);
        }
    }
}
